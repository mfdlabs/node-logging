 ...
 */
 ...
 'The `this` keyword is the incorrect type, if you are applying this to a callback, please use logger.{method}.bind(logger) instead.' as const;
...
/**
* This is an error message for when the value you supply for a setter is empty.
*
* @internal This is only ingested internally.
* @constant
* @type {string} The error message.
*/
export const setterValueCannotBeEmpty: string = 'The `value` argument cannot be empty.' as const;
...
* @type {string} The error message.
*/
export const invalidLoggerName: string =
 'Invalid logger name. Logger names can only be 100 characters long, and can only contain letters, numbers, underscores, and dashes.' as const;
...
/**
* This is an error message for when you supply a logWithColor value to the constructor that is undefined or null.
*
* @internal This is only ingested internally.
* @constant
* @type {string} The error message.
*/
export const invalidConstructorLogWithColor: string =
 'The `logWithColor` argument cannot be undefined or null.' as const;

/**
* This is an error message for when you supply a logWithColor value to the constructor that is not a boolean.
*
* @internal This is only ingested internally.
* @constant
* @type {string} The error message.
*/
export const invalidConstructorCutLogWithColor: string = 'The `logWithColor` argument must be a boolean.' as const;
